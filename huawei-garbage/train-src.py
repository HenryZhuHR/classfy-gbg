...
# Datasets
parser.add_argument('-train', default='data/new_shu_label.txt', type=str,help="训练集的地址") #new_shu_label
parser.add_argument('-val',  default='data/val1.txt', type=str,help="验证集的地址")

parser.add_argument('-j', '--workers', default=4, type=int, metavar='N',
                    help='number of data loading workers (default: 4)')
# Optimization options
parser.add_argument('--epochs', default=200, type=int, metavar='N',
                    help='总训练轮数 / number of total epochs to run')
...
parser.add_argument('--train-batch', default=1, type=int, metavar='N',  ### train batch size
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='./checkepoints', type=str, metavar='PATH',
...
def main():
    ...
    trainset = dataset.Dataset(root=args.train, transform=transform['val_train'])
    train_loader = data.DataLoader(trainset, batch_size=args.train_batch, shuffle=True, num_workers=args.workers, pin_memory=True)
    # exit()

    valset = dataset.TestDataset(root=args.val, transform=transform['val_test'])
